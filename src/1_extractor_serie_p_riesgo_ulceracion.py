...
# Configuración de extracción Serie P4
CONFIG_EXTRACCION = [
    {"fila": "61", "riesgo": "Bajo"},
    {"fila": "62", "riesgo": "Moderado"},
    {"fila": "63", "riesgo": "Alto"},
    {"fila": "64", "riesgo": "Máximo"}
]
...
if datos_maestros:
    ...
    ruta_xlsx = os.path.join(RUTA_SALIDA_CARPETA, "p_evaluacion_vigente_riesgo_ulceracion.xlsx")
    df_final.to_excel(ruta_xlsx, index=False, sheet_name="RIESGO")
