...
# Configuración de extracción Serie P4 (Amputaciones DM)
CONFIG_EXTRACCION = [
    {"fila": "68", "label": "Amputación pie diabético"}
]
...
if datos_maestros:
    ...
    ruta_xlsx = os.path.join(RUTA_SALIDA_CARPETA, "p_amputacion_por_pie_diabetico.xlsx")
    df_final.to_excel(ruta_xlsx, index=False, sheet_name="AMPUTACION")
